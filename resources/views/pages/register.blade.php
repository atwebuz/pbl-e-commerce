...
<form class="col-md-6 col-12 my-5 m-auto" method="POST"">
    @csrf
    <div class="mb-3">
      <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="Your Name" autocomplete="off">
    </div>

    <div class="mb-3">
        <input type="text" class="form-control" id="exampleInputEmail1" name="surname" placeholder="Your Surname" autocomplete="off">
    </div>

    <div class="mb-3">
        <input type="tel" class="form-control" id="exampleInputEmail1" name="tel" placeholder="Your Phone" autocomplete="off">
    </div>
    ...
    <div class="mb-3">
        <input type="password" class="form-control" id="exampleInputPassword1" name="retypassword" placeholder="Retype Password" autocomplete="off">
      </div>
    ...
    <button type="submit" style="background: var(--light-blue); color: var(--white);" class="btn w-100">Registration</button>
  </form>
</div>
  @endsection
